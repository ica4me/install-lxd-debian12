...
echo "Jika tidak diisi selama 5 detik, password akan digenerate otomatis."
# Prompt password disembunyikan (-s) dengan limit 5 detik (-t 5)
read -t 5 -s -p "Masukkan Password: " ROOT_PASS
echo ""
